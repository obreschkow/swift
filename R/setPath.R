...
#'               \item \code{"snapshot"}: path to the HDF5 particle snapshot file. This must be the full path+filename, including file extension (.hdf/.hdf5/.h5) and subvolume placeholder `%d` if available.
...
#'
#' @examples
#' setPath("snapshot", "/data/snapshot_199.%d.hdf5")
#'
#' @export
#'
